...
attack_probabilities = {
    'DDoS': np.array([0.070, 0.080, 0.005, 0.013, 0.110, 0.090, 0.095, 0.065, 0.175, 0.055, 0.094, 0.093]),
    'DoS': np.array([0.060, 0.078, 0.004, 0.020, 0.128, 0.087, 0.085, 0.053, 0.182, 0.048, 0.097, 0.100]),
    'Recon': np.array([0.040, 0.092, 0.003, 0.028, 0.118, 0.085, 0.105, 0.048, 0.170, 0.101, 0.086, 0.078]),
    'Mirai': np.array([0.050, 0.075, 0.003, 0.015, 0.125, 0.102, 0.113, 0.057, 0.162, 0.051, 0.094, 0.101]),
    'Spoofing': np.array([0.080, 0.052, 0.007, 0.016, 0.150, 0.116, 0.035, 0.044, 0.178, 0.045, 0.142, 0.089]),
    'Web-Attacks': np.array([0.190, 0.010, 0.015, 0.015, 0.020, 0.380, 0.010, 0.015, 0.020, 0.190, 0.020, 0.175])
}
